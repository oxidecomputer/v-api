...
See: [CHANGELOG.md](https://github.com/oxidecomputer/v-api/blob/main/remix-auth-vapi/CHANGELOG.md) for release details.
...
Otherwise strategies default to `v-api-{provider}` (OAuth) and `v-api-magic-link` (magic link).
